...
import type { AuthUser, BreadcrumbItem, NavItem, SharedData } from '@/types';
...
// This header only renders for authenticated users.
const user = computed(() => auth.value.user as AuthUser);
