            ...
            <div class="overflow-x-auto rounded-xl border border-sidebar-border/70 dark:border-sidebar-border">
                <table class="w-full min-w-[860px] text-sm">
                    ...
                    <tbody>
                        ...
                        <tr v-for="b in bookings.data" :key="b.id" class="cursor-pointer border-b last:border-0 hover:bg-muted/30" @click="router.get(`/admin/bookings/${b.id}`)">
                            ...
                            <td class="px-4 py-3"><span class="inline-flex rounded-full px-2 py-0.5 text-xs font-medium" :class="statusStyle[b.status] ?? 'bg-muted text-muted-foreground'">{{ b.status_label }}</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
