...
return [
    ...
    */
    ...
    |
    | Note: this project stores its pages in `resources/js/pages` (lowercase),
    | so the path is set accordingly — the package default (`js/Pages`) only
    | resolves on case-insensitive filesystems and breaks on Linux/CI.
    |
    */
